...
const tailoredSkillSchema = z.object({
  name: z
    .string()
    .min(1)
    .describe("Skill category name, e.g. 'Frontend Development', 'Cloud Infrastructure'."),
  keywords: z
    .array(z.string())
    .describe(
      "Specific technologies or competencies displayed as tags, e.g. ['React', 'TypeScript', 'Next.js'].",
    ),
  proficiency: z
    .string()
    .describe(
      "Proficiency label, e.g. 'Advanced', 'Intermediate', 'Developer', 'Languages'. Use consistent style.",
    ),
  icon: z
    .string()
    .describe(
    ...
    .array(
      z.object({
        index: z
          .number()
          .describe(
            "Zero-based index of the experience item in the resume's sections.experience.items array.",
          ),
        description: z
          .string()
          .describe(
        ...
        roles: z
          .array(
            z.object({
              index: z
                .number()
                .describe("Zero-based index of the role within this experience's roles array."),
              description: z
                .string()
                .describe(
    ...
    .array(
      z.object({
        index: z
          .number()
          .describe(
            "Zero-based index of the reference item in the resume's sections.references.items array.",
          ),
        description: z
          .string()
          .describe(
