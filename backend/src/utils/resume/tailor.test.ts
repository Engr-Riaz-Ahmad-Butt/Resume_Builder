...
describe("sanitizeText", () => {
  ...
  it("leaves normal ASCII text unchanged", () => {
    expect(sanitizeText("<p>Normal text - with hyphens.</p>")).toBe(
      "<p>Normal text - with hyphens.</p>",
    );
  });
});
...
describe("tailorOutputToPatches", () => {
  ...
  it("sanitizes experience descriptions", () => {
    const output: TailorOutput = {
      ...
      experiences: [
        {
          index: 0,
          description: "<p>Led team \u2013 built \u201Cgreat\u201D things</p>",
          roles: [],
        },
      ],
    };
      ...
      references: [
        {
          index: 0,
          description:
            "<p>Jane supervised my engineering work and can speak to my technical skills.</p>",
        },
      ],
    };
  ...
  it("hides all existing skills and adds curated skills", () => {
    ...
    const addOp = operations.find(
      (op) => op.op === "add" && op.path === "/sections/skills/items/-",
    );
      ...
      experiences: [
        {
          index: 0,
          description: "<p>Ok</p>",
          roles: [{ index: 99, description: "<p>Bad role</p>" }],
        },
      ],
    };
  ...
  it("uses skill icon from AI output", () => {
    const output: TailorOutput = {
      ...emptyTailorOutput,
      skills: [
        { name: "Cloud", keywords: ["AWS"], proficiency: "Advanced", icon: "cloud", isNew: false },
      ],
    };
  ...
  it("defaults empty icon to empty string", () => {
    const output: TailorOutput = {
      ...emptyTailorOutput,
      skills: [
        { name: "Cloud", keywords: ["AWS"], proficiency: "Advanced", icon: "", isNew: false },
      ],
    };
...
describe("validateTailorOutput", () => {
  it("returns empty array for valid output", () => {
    const output: TailorOutput = {
      ...
      skills: [
        { name: "React", keywords: ["Hooks"], proficiency: "Advanced", icon: "code", isNew: false },
      ],
    };
      ...
      experiences: [
        {
          index: 0,
          description: "<p>Ok</p>",
          roles: [{ index: 5, description: "<p>Bad role</p>" }],
        },
      ],
    };
