      ...
      inputSchema: toJsonSchemaCompat(
        z.object({
          data: z
            .unknown()
            .describe(
              "Complete ResumeData JSON (same shape as get_resume output or `resume://_meta/schema`).",
            ),
        }),
      ),
  ...
  const resourceTemplates = [
    {
      ...
      description:
        "Full resume data as JSON. Discover IDs with the list tool; read via resources/read or get_resume.",
      mimeType: "application/json",
    },
  ];
