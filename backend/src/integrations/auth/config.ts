...
const OAUTH_DYNAMIC_CLIENT_REDIRECT_HOSTS = parseAllowedHostList(
  env.OAUTH_DYNAMIC_CLIENT_REDIRECT_HOSTS,
);
    ...
    hooks: {
      before: createAuthMiddleware(async (ctx) => {
        ...
        for (const uri of redirectUris) {
          ...
          if (
            !isAllowedOAuthRedirectUri(uri, TRUSTED_ORIGINS, OAUTH_DYNAMIC_CLIENT_REDIRECT_HOSTS)
          ) {
